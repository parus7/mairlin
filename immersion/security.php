...
<body>
        ...
        *
        *	Return  value:  array с данными пользователя
        **/
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $email ?>" name="emailfrm" >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="simpleinput" class="form-control" name="confirm_passwordfrm">
                                </div>
