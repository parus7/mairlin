                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="namefrm">
                                </div>

                                <!-- title -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Место работы</label>
                                    <input type="text" id="simpleinput" class="form-control" name="professionfrm">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" id="simpleinput" class="form-control" name="telephonefrm">
                                </div>

                                <!-- address -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Адрес</label>
                                    <input type="text" id="simpleinput" class="form-control" name="addressfrm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="emailfrm">
                                </div>

                                <!-- password -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Пароль</label>
                                    <input type="password" id="simpleinput" class="form-control" name="passwordfrm">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="example-select" name="statusfrm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control-file" name="imagefrm">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="vkfrm">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- telegram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="telegramfrm">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- instagram -->
                                        <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                            ...
                                            <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="instafrm">
                                        </div>
                                    </div>
