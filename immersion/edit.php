...
<body>
    ...
    $get_id = $_GET["id"];
        ...
        **/
        ...
        $person = autoriztion4editing($get_id, "users.php");
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-primary-gradient">
        <a class="navbar-brand d-flex align-items-center fw-500" href="pesrons.html"><img alt="logo"
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="edit_handler.php" method="POST">
            <input type="hidden"  value="<?php echo $person_id ?>" name="idfrm">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $name ?>" name="namefrm">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control"
                                        value="<?php echo $profession ?>" name="professionfrm"> 
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input type="text" id="simpleinput" class="form-control" value="<?php echo $telephone ?>" name="telephonefrm">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control"
                                        value="<?php echo $address ?>" name="addressfrm">
                                </div>
