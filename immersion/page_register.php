                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="register_handler.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="email" id="emailverify" class="form-control" placeholder="Эл. адрес" required name="emailfrm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" class="form-control" placeholder="" required name="passwordfrm">
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
